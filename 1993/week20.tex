...
\end{center}
%
and finally one on top -- which I won't attempt to draw. %JB - help:  It would have been difficult to draw in ASCII, but there's no reason not to draw it in the current medium.
...
%JB - help:  This statement (I wish I could draw an icosahedron for you) should be revised for this medium, where it is relatively easy to draw the necessary figures.
\begin{center}
